...
import { ABOUT_BUSINESS_HISTORY_COLLECTION_ID } from "@/components/Collections/view/CompanyInfotabs/AboutBusiness";
...
const RegulatoryHistoryPage = ({ params }: { params: { id: string } }) => {
    ...
    const fetchHistory = async () => {
      try {
        const response = await databases.listDocuments(
          STAGING_DATABASE_ID,
          ABOUT_BUSINESS_HISTORY_COLLECTION_ID,
          [
  ...
  return (
    <div className="p-4">
      <h1 className="text-xl font-bold mb-4">About Business Changes</h1>
      <Table>
        <TableHeader>
          <TableRow>
