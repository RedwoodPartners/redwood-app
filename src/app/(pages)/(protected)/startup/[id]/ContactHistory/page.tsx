...
import { CONTACT_HISTORY_COLLECTION_ID } from "@/components/Collections/view/CompanyInfotabs/Contact";
...
const RegulatoryHistoryPage = ({ params }: { params: { id: string } }) => {
  ...
  return (
    <div className="p-4">
      <h1 className="text-xl font-bold mb-4">Contact History</h1>
      <Table>
        <TableHeader>
          <TableRow>
